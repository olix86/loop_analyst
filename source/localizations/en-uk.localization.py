...
language["main_CMDataFullySpecifiedAlert"] = [("\nA fully connected Community Matrix is not analysable via loop analysis.","Community Matrix Data Error")]
...
language["dialog_ImportCMMessage"] = ["Save file as ..."]
language["dialog_ImportCMWildcard"] = ["CM Library file (*.cml)|*.cml"]
...
language["dialog_PreferencesGraphColorChoices"] = [('Back & White','Greyscale','Colour')]
